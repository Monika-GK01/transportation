...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default: "bg-primary text-primary-foreground hover:bg-primary-hover shadow-custom-sm",
        transport: "bg-transport text-transport-foreground hover:bg-transport-hover shadow-transport transition-bounce",
        success: "bg-success text-success-foreground hover:bg-success/90 shadow-custom-sm",
        warning: "bg-warning text-warning-foreground hover:bg-warning/90 shadow-custom-sm",
        hero: "bg-gradient-hero text-primary-foreground hover:scale-105 shadow-custom-lg transition-bounce",
